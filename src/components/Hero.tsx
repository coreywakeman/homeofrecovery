  ...
  return (
    <section className="relative min-h-screen flex items-center pt-16 lg:pt-20">
      ...
      <div className="absolute inset-0 z-0">
        <img 
          src={heroImage} 
          alt="Peaceful wellness studio interior with natural lighting"
        ...
        <div className="max-w-4xl">
          <div className="animate-fade-in">
            ...
            <p className="text-lg sm:text-xl lg:text-2xl text-muted-foreground mb-8 max-w-2xl leading-relaxed">
              Experience transformative wellness through expert-guided classes, 
              personalized recovery programs, and a supportive community dedicated to your healing journey.
            </p>
            ...
            <div className="grid grid-cols-3 gap-8 pt-8 border-t border-border/50">
              <div className="text-center">
                ...
                <div className="text-sm lg:text-base text-muted-foreground">Members</div>
              </div>
              <div className="text-center">
                <div className="text-2xl lg:text-3xl font-bold text-primary mb-2">15+</div>
                <div className="text-sm lg:text-base text-muted-foreground">Expert Coaches</div>
              </div>
              <div className="text-center">
