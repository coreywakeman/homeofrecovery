        ...
        <div className="absolute inset-0 flex items-center justify-center px-4">
          ...
          >
            ...
            >
              ...
              <p 
                className="font-body text-white/85 leading-relaxed max-w-3xl mx-auto mb-8"
                style={{
              ...
              <Button 
                ...
                variant="ghost"
                className="bg-white/10 backdrop-blur-md border border-white/20 text-white hover:bg-white/20 transition-all duration-300 rounded-xl px-8 py-6 text-lg"
              >
                Explore Services
              </Button>
            </div>
