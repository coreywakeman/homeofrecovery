...
const Index = () => {
  ...
  return (
    <div className="relative w-screen h-screen overflow-hidden">
      ...
      {/* Minimal Navigation */}
      <nav className="absolute top-0 left-0 right-0 z-50 px-6 md:px-12 py-4 flex items-center justify-between animate-fade-in" style={{ animationDelay: "300ms", animationDuration: "600ms" }}>
        {/* Logo */}
